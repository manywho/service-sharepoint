...
public class SessionResponseHandler implements ResponseHandler {
    ...
    @Override
    public SessionCreated handleResponse(HttpResponse httpResponse) throws IOException {
        ...
        if (status >= 200 && status < 300) {
            ...
            if (entity2 == null) {
                ...
                return mapper.readValue(EntityUtils.toString(entity2), SessionCreated.class);
            }
        }
