...
public interface SharePointFacadeInterface {
    List<MObject> fetchSites(ApplicationConfiguration configuration, String token) throws ExecutionException, InterruptedException;

    List<MObject> fetchSites(ApplicationConfiguration configuration, String token, String parentId);

    MObject fetchSite(ApplicationConfiguration configuration, String token, String id);
